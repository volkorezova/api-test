...
public class DatumAssert extends AbstractAssert<DatumAssert, Datum> {
  ...
  /**
   * Verifies that the actual Datum's age is equal to the given one.
   * @param age the given age to compare the actual Datum's age to.
   * @return this assertion object.
   * @throws AssertionError - if the actual Datum's age is not equal to the given one.
   */
  public DatumAssert hasAge(Integer age) {
    // check that actual Datum we want to make assertions on is not null.
    isNotNull();
  ...
  /**
   * Verifies that the actual Datum's birthDate is equal to the given one.
   * @param birthDate the given birthDate to compare the actual Datum's birthDate to.
   * @return this assertion object.
   * @throws AssertionError - if the actual Datum's birthDate is not equal to the given one.
   */
  public DatumAssert hasBirthDate(String birthDate) {
    // check that actual Datum we want to make assertions on is not null.
    isNotNull();
  ...
  /**
   * Verifies that the actual Datum's height is equal to the given one.
   * @param height the given height to compare the actual Datum's height to.
   * @return this assertion object.
   * @throws AssertionError - if the actual Datum's height is not equal to the given one.
   */
  public DatumAssert hasHeight(Integer height) {
    // check that actual Datum we want to make assertions on is not null.
    isNotNull();
  ...
  /**
   * Verifies that the actual Datum's weight is equal to the given one.
   * @param weight the given weight to compare the actual Datum's weight to.
   * @return this assertion object.
   * @throws AssertionError - if the actual Datum's weight is not equal to the given one.
   */
  public DatumAssert hasWeight(Integer weight) {
    // check that actual Datum we want to make assertions on is not null.
    isNotNull();
